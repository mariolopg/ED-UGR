 ...
 * @author Marina Muñoz Cano, Mario López González
 */
...
public:
  ...
  */
  ...
  /**
   * @brief Calcula el valor real de un racional
   * @return Devuelve el valor real asociado al racional
   */
  double valorReal();

  /**
   * @brief Sobrecarga del operador -
   * @param r racional a restar con el objeto impl�cito
   */
  Racional operator-(const Racional &r);

  /**
   * @brief Sobrecarga del operador /
   * @param r racional a dividir con el objeto impl�cito
   */
  Racional operator/(const Racional &r);

  /**
   * @brief Indica si un racional es irreducible o no
   */
  bool es_irreducible();
};
